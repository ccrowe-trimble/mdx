...
function PageDynamicMdxProduction() {
...
<CustomComponent/>
 `;
    ...
    return (
        <>
            <div>Below is an example of dynamically generated MDX content in a production build:</div>
            <CustomMDXProvider>
                {MdxComponent}
            </CustomMDXProvider>
...
export default PageDynamicMdxProduction;